  ...
  >
    ...
    <div class="d-flex flex-column ma-3">
      <div class="d-flex justify-space-between">
        <span class="heading-5">test</span>
      ...
      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus alias, cumque dolore et minus nulla possimus repellat similique voluptas voluptatem! Animi assumenda error explicabo incidunt laborum nihil veniam voluptatem voluptates!</p>
    </div>
  </v-card>
</template>
