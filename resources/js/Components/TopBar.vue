<template>
  <div class="app-top-bar pa-2">
    <div class="d-flex justify-space-between align-center">
      <v-btn icon variant="text" @click="this.$emit('sidebar')">
        <svg fill="#A3AED0" height="24" width="24" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
...
<g id="SVGRepo_bgCarrier" stroke-width="0"/>
          ...
          <g id="SVGRepo_iconCarrier"> <path
            d="M28,0C12.561,0,0,12.561,0,28s12.561,28,28,28s28-12.561,28-28S43.439,0,28,0z M40,41H16c-1.104,0-2-0.896-2-2s0.896-2,2-2 h24c1.104,0,2,0.896,2,2S41.104,41,40,41z M40,30H16c-1.104,0-2-0.896-2-2s0.896-2,2-2h24c1.104,0,2,0.896,2,2S41.104,30,40,30z M40,19H16c-1.104,0-2-0.896-2-2s0.896-2,2-2h24c1.104,0,2,0.896,2,2S41.104,19,40,19z"/> </g>

</svg>
      </v-btn>
      <!--  <v-img src="https://i.postimg.cc/sX4pF3nH/Elipse-5.png" rounded></v-img>-->
      <!--  <v-avatar image="https://i.postimg.cc/sX4pF3nH/Elipse-5.png"></v-avatar>-->
      <v-btn icon variant="text" @click="this.$emit('settings')">
        <svg fill="#A3AED0" height="24" width="64px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
             xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 489.802 489.802" xml:space="preserve">
