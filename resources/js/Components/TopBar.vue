...
<v-btn icon variant="text" @click="this.$emit('settings')">
  <svg fill="#A3AED0" height="24" width="64px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 489.802 489.802" xml:space="preserve">
